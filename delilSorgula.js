// example.cjs
const { PaketDelilSorgula, PaketSorgula } = require("./kepClient.js"); // CJS sürümünü içe aktar

const { delilIndir } = require("./delilIndir.js");
const fs = require("fs");
...
async function main() {
  ...
  //test kepid boşuna sorgulamaya çalışmayın :)
  const index = paketSorgula.return.kepId.indexOf(
    "<EYWS96dc54a1-b02a-427d-8feb-9ee64f0c43dc.26112025161217.pttkepMimeyap>"
  );
  ...
  paketDelilSorgula.return.delilId.forEach((element, index) => {
    deliller.push({
      ...
      delilaciklama:
        DelilTurDescription[paketDelilSorgula.return.delilTurId[index]] ||
        "Bilinmeyen delil türü",
    });
  });
